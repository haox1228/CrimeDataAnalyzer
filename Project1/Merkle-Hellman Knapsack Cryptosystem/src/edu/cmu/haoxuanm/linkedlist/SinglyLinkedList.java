package edu.cmu.haoxuanm.linkedlist;
...
public class SinglyLinkedList {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(revLL.toString());
        System.out.println(ll.iterator.getData().toString());
        ll.iterator = ll.iterator.getLink().getLink().getLink().getLink();
        System.out.println(ll.iterator.getData().toString());
        ll.reset();
        while (ll.hasNext()) {
            System.out.print(ll.next());
        }
        System.out.println(ll.getObjectAt(3));
    }
}
