...
public class ObjectNode {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Number of Nodes = " + listLength(k));
        System.out.println("Number of Nodes = " + listLength_rec(k));
        ObjectNode k2 = listCopy_rec(theHead);
        System.out.println(k2.toString());
        System.out.println("Number of Nodes = " + listLength(k2));
        System.out.println("Number of Nodes = " + listLength_rec(k2));
